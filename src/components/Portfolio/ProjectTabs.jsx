      ...
      <div className="projects mt-5 mx-auto w-full grid grid-cols-1 items-center justify-center md:grid-cols-2 gap-5 ">

        {
          projects?.map(project => (
            <Project key={project.id}  project={{ type: project.type, title: project.title, description: project.description, tags: project.tags, cover: project.cover,images:project.images }} delay={0.3} />
          ))
        }
